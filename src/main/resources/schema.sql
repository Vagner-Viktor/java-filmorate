...
CREATE TABLE IF NOT EXISTS "feedbacks" (
    ...
    "feedback" VARCHAR UNIQUE NOT NULL
);
...
CREATE TABLE IF NOT EXISTS "reviews" (
    ...
    "content" VARCHAR,
    "feedback_id" BIGINT NOT NULL REFERENCES "feedbacks" ("feedback_id") ON DELETE CASCADE
);

CREATE TABLE IF NOT EXISTS "usability_reviews" (
    "usability_review_id" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
